...
export const routeExamples = [
  {
    ...
    routes: [
      { transport: "Metro", duration: 12, cost: 4.65, frequency: "5min" },
      { transport: "Bus", duration: 25, cost: 4.65, frequency: "10min" },
  ...
  },
  {
    ...
    routes: [
      { transport: "Bus", duration: 8, cost: 4.65, frequency: "8min" },
      { transport: "Vélo", duration: 10, cost: 0, frequency: "N/A" },
      { transport: "Voiture", duration: 6, cost: 7.75, frequency: "N/A" }
    ]
  },
  {
    from: "Banlieue",
    to: "Hyper Centre",
    routes: [
      { transport: "Train", duration: 20, cost: 9.30, frequency: "15min" },
      { transport: "Bus", duration: 35, cost: 4.65, frequency: "20min" },
      { transport: "Voiture", duration: 25, cost: 7.75, frequency: "N/A" }
    ]
  }
];
